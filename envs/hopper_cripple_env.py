...
class CrippleHopperEnv(mujoco_env.MujocoEnv, utils.EzPickle):
    def __init__(
        self, cripple_set=[0, 1, 2, 3], extreme_set=[0], mass_scale_set=[1.0], causal_dim=-1, causal_hidden_dim=-1
    ):
    ...
    def _set_observation_space(self, observation):
        super(CrippleHopperEnv, self)._set_observation_space(observation)
